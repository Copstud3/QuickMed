...
const BackToTopButton = () => {
  ...
  return (
    isVisible && (
      <button
        onClick={scrollToTop}
        className="fixed bottom-10 right-10 max-sm:p-3 max-sm:right-5 bg-purple-gradient text-white p-4 rounded-full shadow-lg transition-transform transform hover:scale-110"
      >
        ↑
      </button>
    )
